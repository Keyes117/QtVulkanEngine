...
Device::Device(MyVulkanWindow& window) : m_window{ window } {
    createInstance();
    setupDebugMessenger();
    createSurface();
    pickPhysicalDevice();
...
void Device::createLogicalDevice() {
    ...
    vkGetDeviceQueue(m_VkDevice, indices.graphicsFamily, 0, &m_graphicsQueue);
    vkGetDeviceQueue(m_VkDevice, indices.presentFamily, 0, &m_presentQueue);
}
...
void Device::checkInstanceExtensionSupport(const std::vector<const char*>& required)
{
    uint32_t extCount = 0;
