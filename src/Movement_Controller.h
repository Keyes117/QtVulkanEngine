...
{
public:
    Keyboard_Movement_Controller(const std::shared_ptr<Object>& object, Camera& camera);
...
{
public:
    Mouse_Movement_Controller(const std::shared_ptr<Object>& object, Camera& camera);
